...
- `grave` → "Mate": voces de **órgano** graves, armónicas y musicales (sin golpe). gDark=órgano grave, gLow=órgano cálido, gSub=pedal (sub), gReese=acorde de órgano, gTom=órgano medio, gThud=octava, gGrowl=órgano reed, gDrone=pad sostenido (para "al cielo"). Ataque suave, sostenido con cola corta; distintas por registro/voz. **Familia por defecto** (`let _familia = 'grave'`). Iteró varias veces (jun 2026): notas largas sostenidas → techno percusivo → **órgano armónico** (lo que pidió el owner: "notas musicales graves de órgano, menos golpe").
